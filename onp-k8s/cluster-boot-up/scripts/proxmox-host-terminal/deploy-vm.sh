...
TEMPLATE_VMID=9050
CLOUDINIT_IMAGE_TARGET_VOLUME=local-NFS
TEMPLATE_BOOT_IMAGE_TARGET_VOLUME=local-NFS
BOOT_IMAGE_TARGET_VOLUME=local-NFS
SNIPPET_TARGET_VOLUME=local-NFS
SNIPPET_TARGET_PATH=/mnt/pve/local-NFS/snippets
...
VM_LIST=(
    ...
    "1001 cp-1 8 16384 192.168.0.11 192.168.0.11 192.168.0.85 pve"
    "1002 cp-2 4 8192 192.168.0.12 192.168.0.12 192.168.0.86 pve1"
    "1003 cp-3 2 7168 192.168.0.13 192.168.0.13 192.168.0.87 commet"
    "1101 wk-1 8 16384 192.168.0.21 192.168.0.21 192.168.0.85 pve"
    "1102 wk-2 4 32768 192.168.0.22 192.168.0.22 192.168.0.86 pve1"
